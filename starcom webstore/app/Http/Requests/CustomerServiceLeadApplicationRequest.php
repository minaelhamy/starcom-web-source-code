...
class CustomerServiceLeadApplicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tax_card_documents.*' => ['nullable', 'file', 'mimes:jpg,jpeg,png,webp,pdf', 'max:5120'],
            'rent_contract_documents' => ['nullable', 'array', 'max:4'],
            'rent_contract_documents.*' => ['nullable', 'file', 'mimes:jpg,jpeg,png,webp,pdf', 'max:5120'],
            'utility_bill_documents' => ['nullable', 'array', 'max:4'],
            'utility_bill_documents.*' => ['nullable', 'file', 'mimes:jpg,jpeg,png,webp,pdf', 'max:5120'],
            'additional_documents' => ['nullable', 'array', 'max:4'],
            'additional_documents.*' => ['nullable', 'file', 'mimes:jpg,jpeg,png,webp,pdf', 'max:5120'],
