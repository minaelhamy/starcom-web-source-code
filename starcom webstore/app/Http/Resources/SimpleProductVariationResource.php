...
class SimpleProductVariationResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'sku'                           => $this->sku,
            'stock'                         => $this->product?->show_stock_out == Activity::DISABLE ? ($this->product?->can_purchasable == Ask::NO ? (float)env('NON_PURCHASE_QUANTITY') : max(0, round((float)$this->stock_items_sum_quantity, 2))) : 0,
