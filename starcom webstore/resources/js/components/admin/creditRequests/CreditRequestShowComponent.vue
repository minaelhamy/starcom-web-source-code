            ...
            <div class="row p-4">
                <div class="col-12 lg:col-6">
                    <div class="space-y-2 text-sm">
                        ...
                        <div><span class="font-semibold">خط العرض:</span> {{ application.user?.latitude || "--" }}</div>
                        <div><span class="font-semibold">خط الطول:</span> {{ application.user?.longitude || "--" }}</div>
            ...
            <div class="row p-4">
                ...
                <div class="col-12 md:col-6 xl:col-4">
                    <div class="db-card p-4 h-full">
                        ...
                        <div class="flex flex-col gap-2">
                            <a v-for="(document, index) in application.tax_card_documents || []" :key="`tax-${document}`" :href="document" target="_blank" download class="db-btn py-2 text-white bg-primary">تحميل البطاقة الضريبية {{ index + 1 }}</a>
                            <span v-if="!(application.tax_card_documents || []).length" class="text-sm text-text">غير مرفوعة.</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 md:col-6 xl:col-4">
                    <div class="db-card p-4 h-full">
                        ...
                        <div class="flex flex-col gap-2">
                            <a v-for="(document, index) in application.rent_contract_documents || []" :key="`rent-${document}`" :href="document" target="_blank" download class="db-btn py-2 text-white bg-primary">تحميل عقد الايجار {{ index + 1 }}</a>
                            <span v-if="!(application.rent_contract_documents || []).length" class="text-sm text-text">غير مرفوع.</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 md:col-6 xl:col-4">
                    <div class="db-card p-4 h-full">
                        ...
                        <div class="flex flex-col gap-2">
                            <a v-for="(document, index) in application.utility_bill_documents || []" :key="`utility-${document}`" :href="document" target="_blank" download class="db-btn py-2 text-white bg-primary">تحميل ايصال المرافق {{ index + 1 }}</a>
                            <span v-if="!(application.utility_bill_documents || []).length" class="text-sm text-text">غير مرفوع.</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 md:col-6 xl:col-4">
                    <div class="db-card p-4 h-full">
                        ...
                        <div class="flex flex-col gap-2">
                            <a v-for="(document, index) in application.additional_documents || []" :key="`additional-${document}`" :href="document" target="_blank" download class="db-btn py-2 text-white bg-primary">تحميل مستند إضافي {{ index + 1 }}</a>
                            <span v-if="!(application.additional_documents || []).length" class="text-sm text-text">غير مرفوع.</span>
                        </div>
                    </div>
                </div>
            </div>
